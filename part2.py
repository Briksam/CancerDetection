...
labels_df = pd.read_csv("C:/Users/break/Desktop/project2/train.csv")
...
labels_df['metastasis_ratio'].value_counts()



imgpath = 'C:/Users/break/Desktop/project2/train' 
...
data_dir = 'C:/Users/break/Desktop/project2/'
...
params_model={
        "shape_in": (3,195,195), 
        "initial_filters": 8,    
        "num_fc1": 100} #,"dropout_rate": 0.55,  #0.25}
...
def train_val(model, params,verbose=True):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if(verbose):
            print(f"train loss: {train_loss:.6f}, dev loss: {val_loss:.6f}")
            print("-"*10) 
...
cnn_model,loss_hist=train_val(cnn_model,params_train)
...
path_sub = "C:/Users/break/Desktop/project2/sample_submission.csv"
...
url3 = "C:/Users/break/Desktop/project2/sample_submission.csv"
import pandas as pd
sample=pd.read_csv(url3)
sample['predicted_metastasis_ratio']=preds
sample.to_csv("C:/Users/break/Desktop/project2/submission.csv")